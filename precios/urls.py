...
urlpatterns = [
    ...
    path('productos/filtrados-pdf/', views.productos_filtrados_pdf, name='productos_filtrados_pdf'),
    path('productos/test-pdf/', views.test_pdf_simple, name='test_pdf_simple'),
]
